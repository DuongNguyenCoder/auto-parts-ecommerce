...
export default function CheckOutPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<
    "CASH_ON_DELIVERY" | "BANK_TRANSFER" | "CREDIT_CARD" | "E_WALLET"
  >("CASH_ON_DELIVERY");
  ...
  const handleSubmit = async () => {
    ...
    await handleConfirmOrder({ paymentMethod, shippingMethod, note });
  };
    ...
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-600">
          ...
          hàng. Quy trình thanh toán của bạn gồm ba bước rõ ràng.
        </p>
      </div>

      <div className="grid gap-6 xl:grid-cols-[1.6fr_0.9fr]">
        <section className="space-y-6">
          <CheckoutStepIndicator steps={stepLabels} activeIndex={activeStep} />
          ...
          {activeStep === 0 && (
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Xem lại các sản phẩm, điều chỉnh số lượng hoặc loại bỏ sản phẩm
                nếu cần.
              </p>
              <div className="mt-6">
                <CheckoutItemList
                    ...
                    {shippingOptions.map((option) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            setShippingMethod(
                              option.value as typeof shippingMethod,
                            )
                          }
                          className="sr-only"
                        />
                    ...
                    {paymentOptions.map((option) => (
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            setPaymentMethod(
                              option.value as typeof paymentMethod,
                            )
                          }
                          className="sr-only"
                        />
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="grid gap-4 rounded-3xl border border-gray-200 bg-white p-4">
                  ...
                  {note ? (
                    <div className="text-sm text-gray-600">
                      <div className="font-semibold text-gray-900">Ghi chú</div>
